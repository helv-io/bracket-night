...
Generated: 2026-09-09T18:47:22.845Z
Result: **18/18 passed**
...
| --- | --- | --- | --- | ---: |
| PASS | engine | `engine-4p-8c` | 4 players / 8 contestants to a single champion | 1 |
...
| PASS | engine | `engine-disconnect-reconnect` | Disconnect keeps player id; reconnect by name; vote still locks | 1 |
...
| PASS | socket | `socket-4p-showcase` | Live Socket.IO: 4 bots, showcase, champion | 56 |
| PASS | socket | `socket-unknown-room` | Live Socket.IO: unknown room is a clear reject | 7 |
| PASS | socket | `socket-late-join` | Live Socket.IO: late join rejected after start | 13 |
| PASS | socket | `socket-reconnect` | Live Socket.IO: disconnect and reconnect by name | 58 |
| PASS | socket | `socket-tie-coin` | Live Socket.IO: even split -> coin phase | 21 |
| PASS | socket | `socket-host-resolve` | Live Socket.IO: host resolve_now after disconnects | 61 |
| PASS | socket | `socket-16p` | Live Socket.IO: 16 bots / 16 contestants to champion | 276 |
