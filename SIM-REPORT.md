...
Generated: 2026-09-09T15:10:49.150Z
Result: **18/18 passed**
...
| --- | --- | --- | --- | ---: |
| PASS | engine | `engine-4p-8c` | 4 players / 8 contestants to a single champion | 3 |
...
| PASS | engine | `engine-byes-12` | 12 contestants pad to 16 with byes | 1 |
| PASS | engine | `engine-tie-coin` | Even split emits wasTie and coin phase | 0 |
...
| PASS | engine | `engine-room-full` | Room full at 16 | 1 |
...
| PASS | socket | `socket-4p-showcase` | Live Socket.IO: 4 bots, showcase, champion | 59 |
| PASS | socket | `socket-unknown-room` | Live Socket.IO: unknown room is a clear reject | 9 |
| PASS | socket | `socket-late-join` | Live Socket.IO: late join rejected after start | 19 |
| PASS | socket | `socket-reconnect` | Live Socket.IO: disconnect and reconnect by name | 63 |
| PASS | socket | `socket-tie-coin` | Live Socket.IO: even split -> coin phase | 12 |
| PASS | socket | `socket-host-resolve` | Live Socket.IO: host resolve_now after disconnects | 54 |
| PASS | socket | `socket-16p` | Live Socket.IO: 16 bots / 16 contestants to champion | 265 |
